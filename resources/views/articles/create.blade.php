    ...
    <div class="container pt-5">
        ...
        <form action="{{ route('articles.store') }}" enctype="multipart/form-data" method="POST" class="pt-5">
            ...
            <div class="form-group d-flex align-items-center">
                ...
                <input type="file" name="bg_img_path" id="bg_img_path" class="form-controll" accept="image/*">
                <img id="preview" width="200px">
            </div>

            <div class="form-group d-flex align-items-center">
                <label for="img_path" class="mb-0 w-25">画像リスト（複数可）</label>
                <input type="file" name="img_path[]" id="img_path" class="form-controll" multiple accept="image/*">
